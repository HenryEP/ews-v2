    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 to-blue-900 px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">EWS</h1>
          <p className="text-sm text-gray-500 mt-1">Early Warning System</p>
          <p className="text-xs text-gray-400 mt-3">Sistem Pemantauan Anggaran Proyek</p>
        </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Demo v1.0 — Fase A: Fondasi & Autentikasi
        </p>
      </div>
    </div>
  );
