        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Ringkasan Eksekutif</p>
            </div>
          </div>
              ...
              <tbody>
                {projects.map((p) => (
                  <tr
                    ...
                    onClick={() => navigate(`/owner/projects/${p.id}`)}
                  >
                    <td className="px-6 py-3 font-medium text-gray-800">{p.name}</td>
                    <td className="px-6 py-3 text-gray-600 text-xs">{p.type}</td>
                    ...
                    <td className="px-6 py-3">
                      <div className="flex items-center gap-2">
                        <div className="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div
                            className={`h-full rounded-full transition-all ${progressColor[p.ewsStatus] || "bg-gray-400"}`}
